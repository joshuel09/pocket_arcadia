...
/**
 * Created by Josusama on 3/5/2018.
 */
...
public class GameView extends SurfaceView implements Runnable {
    ...
    public GameView(Context context, int screenSizeX, int screenSizeY) {
        ...
        mp = MediaPlayer.create(getContext(), R.raw.ppbgm);
        mp.setLooping(false);
        mp.setVolume(100,100);

        gameover = MediaPlayer.create(getContext(), R.raw.pp_gameover);
        gameover.setLooping(false);
        gameover.setVolume(100,100);
    ...
    void drawGameOver(Context context) {
        ...
        mCanvas.drawText("Isa Kang Bayani..", mScreenSizeX / 2, (mScreenSizeY / 2) + 60, bayani);
        ...
        mCanvas.drawText("HighScore : " + mSP.getHighScore(), mScreenSizeX / 2, (mScreenSizeY / 2) + 250, highScore);
        ...
        score.setColor(Color.WHITE);
        mCanvas.drawText("Your Score : " + SCORE, mScreenSizeX / 2, (mScreenSizeY / 2) + 150, score);
    }
        ...
        switch (event.getAction()) {
            case MotionEvent.ACTION_DOWN:
                if (mIsGameOver){
                    gameover.stop();
                    mcontext = getContext();
                    Intent intent = new Intent(mcontext, Pulispangkalawakan.class);
